...
hist(car_details$selling_price_in_10k,xlab="Selling Price (10,000 INR)",
...
```
<!-- Need some commentary about this plot -->
...
- The Individual seller type cars have the lowest median cost.
...
- We can see that there is a slight difference in the selling price of the Automatic and Manual transmission cars. The median cost of Automatic transmission cars is higher than that of Manual transmission cars. 
...
- The selling prices of cars across different owner types are significantly different. The median price of test drive cars are very high and the rest of the owner types have low median cost
...
```{r}
# Scatter plot of selling price vs max power
...
```
<!-- This plot needs commentary  -->

- Insert commentary about the above plot here.
...
#### BIC-based stepwise model selection starting from full model (both directions)
```{r}
n= nrow(train_data)
