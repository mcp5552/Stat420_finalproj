...
## Discussion
- The analysis involved multiple linear regression models to understand the factors affecting the selling price of used cars. 
- The models were assessed based on criteria such as 
  1. Adjusted R², 
  2. Number of Parameters
  3. Breusch-Pagan (BP) test, 
  4. Shapiro-Wilk test, 
  5. Variance Inflation Factor (VIF), and 
  6. Leave-One-Out Cross-Validation (LOOCV) RMSE.
...
- The year of manufacture with t_value=116.376 contributed significantly in determining the selling price.
- Newer cars are associated with higher selling prices.

**Engine and max_power:**

- Then the car's max_power and engine with t_value 35.876 and 20.219 respectively also contributed significantly in determining the selling price.
- Higher engine capacity and power increase the car's value.

**Fuel type:**

- Petrol cars are priced significantly lower (t-value = -17.993) compared to diesel cars, which serve as the reference level.

**Transmission:**

- Manual transmission has a negative impact on price (t-value = -5.303), indicating that automatic transmission cars have higher price.

**Other**

 - Similarly Make category,seller_type and ownership history also has significant impact in predicting the selling price.
